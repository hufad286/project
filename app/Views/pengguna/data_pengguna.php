      ...
      <tbody>
        ...
        ?>
            ...
            <tr>
              ...
              <td><?= $baris['Level']; ?></td>
              <td>
                <a href="<?= site_url('hapus-pengguna/') . $baris['idUser']; ?>" class="fas fa-trash" style="color: #0033ff;"></a>
                <a href="<?= site_url('edit-pengguna/') . $baris['idUser']; ?>" class="fas fa-edit" style="color: #0033ff;"></a>
              </td>
