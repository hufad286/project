        ...
        <div class="card-body">
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              ...
              <input type="text" class="form-control" id="inputJenis" name="kode_produk" required name="produk" placeholder="Masukan Kode Produk" autocomplate="off" value="<?= $kode_produk; ?>" readonly>
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              ...
              <input type="text" class="form-control uang" id="inputJenis" name="harga_jual" required name="produk" placeholder="Masukan harga Jual">
            </div>
          </div>
